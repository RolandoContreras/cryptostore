                                ...
                                <div>
                                    <div class="row margin-top-20">
                                        <div class="col-xs-6 col-md-6">
                                             <button onclick="forgot();" class="submit_btn_comprar trans_300"><?=lang('idioma.recuperar_contrasena');?></button>
                                        </div>
                                    </div>
                                </div>
                            <!--</form>-->
                            <br/>
                            <div id="messages" class="alert alert-success" style="text-align: center; display: none;"><?=lang('idioma.login_contrasena_enviada');?></div>
                            <div id="no_messages" class="alert alert-danger" style="text-align: center; display: none;"><?=lang('idioma.login_email_invalido');?></div>
                        </div>
                    </div>
                </div>
            </div>
