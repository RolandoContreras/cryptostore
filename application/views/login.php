                                                        ...
                                                        <div class="reply_form_container">
                                                            ...
                                                            <form method="post" id="form-login">
                                                                    <div class="row">
                                                                        <div class="col-xs-6 col-md-6">
                                                                            <div class="wow bounceInLeft animated animated">
                                                                                <input class="form-control form-control-2" id="reply_form_name" placeholder="Ingrese su Correo" type="text">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-xs-6 col-md-6">
                                                                            <div class="wow bounceInLeft animated animated">
                                                                                <input class="form-control form-control-2" id="reply_form_email" placeholder="Ingrese su Contraseña" type="text">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                <div class="row margintop20">
                                                                    <div class="col-xs-6 col-md-6">
                                                                            <div class="wow bounceInLeft animated animated">
                                                                                  <button id="reply_form_submit" type="submit" class="submit_btn_comprar trans_300" value="Submit">INICIAR SESIÓN</button>
